...
class _AboutAssignmentPageState extends State<AboutAssignmentPage> {
  ...
  Widget build(BuildContext context) {
    final double sliderHeight = MediaQuery.of(context).size.height * 0.48;
...
class _AnimatedSlide extends StatelessWidget {
  ...
  final bool isActive;
  const _AnimatedSlide({required this.slide, required this.isActive});
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      margin: EdgeInsets.symmetric(horizontal: isActive ? 10 : 24, vertical: isActive ? 0 : 16),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: CircleAvatar(
              backgroundImage: AssetImage(slide.image),
              radius: 56,
