...
class CartItemHiveModel extends Equatable {
  ...
  factory CartItemHiveModel.fromEntity(CartItemEntity entity) {
    return CartItemHiveModel(
      ...
      productType: entity.product.type,
      productPrice: entity.product.price,
      productDescription: entity.product.description,
      productImage: entity.product.image,
      categoryId: entity.product.categoryId,
      restaurantId: entity.product.restaurantId,
      isAvailable: entity.product.isAvailable,
      categoryName: entity.product.categoryName,
      categoryImage: entity.product.categoryImage,
      restaurantName: entity.product.restaurantName,
      restaurantImage: entity.product.restaurantImage,
      restaurantLocation: entity.product.restaurantLocation,
      restaurantContact: entity.product.restaurantContact,
